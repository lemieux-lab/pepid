...
#n_meta = 8
    ...
    meta = emb[:,SEQ_SIZE+1:]
    meta[:,0] = inp['mass'] / mass_scale #pepid_utils.neutral_mass(inp['pep'], inp['mods'], NTERM, CTERM, z=1) / mass_scale
    meta[:,1] = inp['charge']
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.decoder = nn.Conv1d(self.emb_size, PROT_BLIT_LEN, kernel_size=1, padding=0)
    ...
    def forward(self, inp):
        ...
        ret = self.dec_pool(self.dec_nl(self.decoder(this_hid))).transpose(2, 1)
        return ret
