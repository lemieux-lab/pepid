...
if __name__ == "__main__":
    ...
    batch_size = blackboard.config['postprocess'].getint('batch size')
    ...
    nworkers = blackboard.config['postprocess'].getint('workers')
    ...
    pepid_mp.handle_nodes("Postprocess", spec, cfg_file=cfg_file, tqdm_silence=log_level in ['fatal', 'error', 'warning'])
